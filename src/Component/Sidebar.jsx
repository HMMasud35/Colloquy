...
const Sidebar = () => {
  return (
    <div>
      <div className='bg-sky-800/80 h-screen shadow-md shadow-gray-100'>
        ...
        <ul className='mt-40'>
          ...
          <li className='bg-sky-700 mt-[-110px] p-3 hover:bg-gray-800/30 border-2 border-sky-800 rounded-4xl flex items-center text-xl font-semibold text-white '><img className='w-20 h-20 bg-amber-200 rounded-full mr-3 ' src="" alt="" />Hasan Masud</li>
        </ul>
      </div>
    </div>
  )
