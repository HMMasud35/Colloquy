      ...
      <div className='w-130 bg-sky-800/50 p-10 border-2 border-[#ffffff46] rounded-2xl backdrop-blur-md relative m-50 ml-80 z-10'>
        ...
        <form onSubmit={handleLogin}>
          <div className='relative w-full h-12.5 border-b-2 border-[#000b13] my-8'>
            ...
            <label className='text-xl text-black font-medium duration-400 top-3 absolute peer-focus:translate-y-[-35px]' htmlFor="email">Email</label>
          </div>
          <div className='relative w-full h-12.5 border-b-2 border-[#000b13] my-8 mb-2'>
            ...
            <label className="text-xl text-black font-medium duration-400 top-3 absolute peer-focus:translate-y-[-35px] peer-valid:translate-y-[-35px]" htmlFor="password">Password</label>
          </div>
